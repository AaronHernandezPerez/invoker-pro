<template>
  <div class="full-height">
    <div class="flex justify-center q-mb-md">
      ...
      <q-btn color="primary" :icon="guideVisible ? 'fas fa-eye-slash' : 'fas fa-eye'"
        @click="guideVisible = !guideVisible" :label="$t('Toggle')" size="sm" />
    </div>
    <expander v-model="guideVisible">
      <InvokerGuideRow class="q-mt-md" :spells="[
